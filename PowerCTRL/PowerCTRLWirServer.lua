...
for _, name in ipairs(peripheral.getNames()) do
    ...
    if peripheral.getType(name) == "modem" and p.isWireless() then modem = p end
end
...
local updateRate = 5 -- Update every 5 seconds
...
while true do
    ...
    if percent <= 0.05 and autoMode then energyFlow = "OVERDRIVE"
    else
    ...
    while true do
        ...
        if ev == "modem_message" and msg and msg.type == "CMD" then
            ...
            break -- Immediate refresh after command
